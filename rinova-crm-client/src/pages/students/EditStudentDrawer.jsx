...
export default function EditStudentDrawer({ open, onClose,student, onSuccess }) {
  const {
    register,
    handleSubmit,
    reset,
    ...
    <>
      ...
      >
        ...
        <div className="flex items-start justify-between border-b bg-white/80 backdrop-blur-md px-6 py-5">
          <div>
            <h2 className="text-2xl font-semibold text-slate-900">Update Student</h2>
            <p className="text-sm text-slate-500 mt-1">Edit your student profile to the system</p>
          </div>
